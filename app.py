...
def render_simulasi_makro_editor() -> pd.DataFrame:
    ...
    st.caption(
        ...
        "Perubahan pada Nilai tukar (Rp100/US$1) memengaruhi Dampak pada Penerimaan Perpajakan, "
        "Penerimaan Negara Bukan Pajak, dan Belanja Pemerintah Pusat sekaligus."
    )
